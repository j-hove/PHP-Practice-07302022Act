...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div>
            8. Write a PHP program to check whether a sequence of numbers is an arithmetic progression or not.<span>(<a href="/">Back to Homepage<a/>)</span><br>
            ...
            Input : array(5, 7, 9, 11)<br>
            Output : An arithmetic sequence<br>
            For example, the sequence 5, 7, 9, 11, 13, 15 ... is an arithmetic progression with common difference of 2.<br><br>
            Answer in number 8 <br><br>
            <?php
